...
.header h1{ background-image:url({$config_siteurl}statics/images/logo.jpg);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright © 2015-2016,www.scyaozhong.com,All rights reserved </p>
     <!-- <p class="copyright_ch"> 版权所有 © 四川尧中检测技术有限公司 未经许可 严禁复制</p>-->
    </div>
  </div>
</div>
